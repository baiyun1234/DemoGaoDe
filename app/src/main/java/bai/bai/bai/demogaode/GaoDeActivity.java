...
public class GaoDeActivity extends AppCompatActivity implements View.OnClickListener
     ...
     */
    private void init() {
        markerText = findViewById(R.id.mark_listenter_text);
        radioOption = findViewById(R.id.custom_info_window_options);

        findViewById(R.id.clearMap).setOnClickListener(this);
        findViewById(R.id.resetMap).setOnClickListener(this);
    ...
    public void onInfoWindowClick(Marker marker) {
        Toast.makeText(GaoDeActivity.this, "你点击了infoWindow窗口" + marker.getTitle(), Toast.LENGTH_SHORT).show();
        Toast.makeText(GaoDeActivity.this, "当前地图可视区域内Marker数量:" + aMap.getMapScreenMarkers().size(), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onMapLoaded() {
        ...
        LatLngBounds bounds = new LatLngBounds.Builder()
                .include(Constants.SHANGHAI).include(Constants.CHENGDU)
